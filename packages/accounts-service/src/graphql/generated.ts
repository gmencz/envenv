...
export type ResetPasswordResult = User | InvalidOrExpiredToken | PasswordsDontMatch | WantsSamePassword | InvalidDataFormat;

export type LoginWithExternalProviderResult = SuccessfulLogin | InvalidOrMissingUserIdentifier | SkippedOAuthFlow;

export type SignupResult = SuccessfulSignup | InvalidDataFormat | TakenUsernameOrEmail;

export type SignupWithExternalProviderResult = SuccessfulSignup | InvalidDataFormat | TakenUsernameOrEmail | SkippedOAuthFlow | InvalidOrExpiredToken;
...
export type ResolversTypes = {
  ...
  DeleteAllUsersResult: ResolversTypes['NotInTestingEnvironment'] | ResolversTypes['SuccessfulRemoval'],
  ...
  ResetPasswordResult: ResolversTypes['User'] | ResolversTypes['InvalidOrExpiredToken'] | ResolversTypes['PasswordsDontMatch'] | ResolversTypes['WantsSamePassword'] | ResolversTypes['InvalidDataFormat'],
  LoginWithExternalProviderResult: ResolversTypes['SuccessfulLogin'] | ResolversTypes['InvalidOrMissingUserIdentifier'] | ResolversTypes['SkippedOAuthFlow'],
  SignupResult: ResolversTypes['SuccessfulSignup'] | ResolversTypes['InvalidDataFormat'] | ResolversTypes['TakenUsernameOrEmail'],
  SignupWithExternalProviderResult: ResolversTypes['SuccessfulSignup'] | ResolversTypes['InvalidDataFormat'] | ResolversTypes['TakenUsernameOrEmail'] | ResolversTypes['SkippedOAuthFlow'] | ResolversTypes['InvalidOrExpiredToken'],
...
export type ResolversParentTypes = {
  ...
  DeleteAllUsersResult: ResolversParentTypes['NotInTestingEnvironment'] | ResolversParentTypes['SuccessfulRemoval'],
  ...
  ResetPasswordResult: ResolversParentTypes['User'] | ResolversParentTypes['InvalidOrExpiredToken'] | ResolversParentTypes['PasswordsDontMatch'] | ResolversParentTypes['WantsSamePassword'] | ResolversParentTypes['InvalidDataFormat'],
  LoginWithExternalProviderResult: ResolversParentTypes['SuccessfulLogin'] | ResolversParentTypes['InvalidOrMissingUserIdentifier'] | ResolversParentTypes['SkippedOAuthFlow'],
  ...
  SignupWithExternalProviderResult: ResolversParentTypes['SuccessfulSignup'] | ResolversParentTypes['InvalidDataFormat'] | ResolversParentTypes['TakenUsernameOrEmail'] | ResolversParentTypes['SkippedOAuthFlow'] | ResolversParentTypes['InvalidOrExpiredToken'],
...
export type MutationResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  ...
  signupWithExternalProvider?: Resolver<ResolversTypes['SignupWithExternalProviderResult'], ParentType, ContextType, RequireFields<MutationSignupWithExternalProviderArgs, 'username'>>,
  login?: Resolver<ResolversTypes['LoginResult'], ParentType, ContextType, RequireFields<MutationLoginArgs, 'username' | 'password'>>,
  loginWithExternalProvider?: Resolver<ResolversTypes['LoginWithExternalProviderResult'], ParentType, ContextType>,
  resetPassword?: Resolver<ResolversTypes['ResetPasswordResult'], ParentType, ContextType, RequireFields<MutationResetPasswordArgs, 'data'>>,
  deleteAllUsers?: Resolver<ResolversTypes['DeleteAllUsersResult'], ParentType, ContextType>,
};
...
export type TakenUsernameOrEmailResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['TakenUsernameOrEmail'] = ResolversParentTypes['TakenUsernameOrEmail']> = {
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type InvalidDataFormatResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['InvalidDataFormat'] = ResolversParentTypes['InvalidDataFormat']> = {
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type SuccessfulSignupResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['SuccessfulSignup'] = ResolversParentTypes['SuccessfulSignup']> = {
  user?: Resolver<ResolversTypes['User'], ParentType, ContextType>,
  csrfToken?: Resolver<ResolversTypes['String'], ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type SuccessfulLoginResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['SuccessfulLogin'] = ResolversParentTypes['SuccessfulLogin']> = {
  user?: Resolver<ResolversTypes['User'], ParentType, ContextType>,
  csrfToken?: Resolver<ResolversTypes['String'], ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type InvalidCredentialsResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['InvalidCredentials'] = ResolversParentTypes['InvalidCredentials']> = {
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type InvalidOrMissingUserIdentifierResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['InvalidOrMissingUserIdentifier'] = ResolversParentTypes['InvalidOrMissingUserIdentifier']> = {
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type InvalidOrExpiredTokenResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['InvalidOrExpiredToken'] = ResolversParentTypes['InvalidOrExpiredToken']> = {
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type PasswordsDontMatchResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['PasswordsDontMatch'] = ResolversParentTypes['PasswordsDontMatch']> = {
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type UserNotFoundResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['UserNotFound'] = ResolversParentTypes['UserNotFound']> = {
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type EmailMayHaveBeenSentResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['EmailMayHaveBeenSent'] = ResolversParentTypes['EmailMayHaveBeenSent']> = {
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type SkippedOAuthFlowResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['SkippedOAuthFlow'] = ResolversParentTypes['SkippedOAuthFlow']> = {
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type NotInTestingEnvironmentResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['NotInTestingEnvironment'] = ResolversParentTypes['NotInTestingEnvironment']> = {
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type SuccessfulRemovalResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['SuccessfulRemoval'] = ResolversParentTypes['SuccessfulRemoval']> = {
  count?: Resolver<ResolversTypes['Int'], ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type WantsSamePasswordResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['WantsSamePassword'] = ResolversParentTypes['WantsSamePassword']> = {
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};

export type DeleteAllUsersResultResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['DeleteAllUsersResult'] = ResolversParentTypes['DeleteAllUsersResult']> = {
  __resolveType: TypeResolveFn<'NotInTestingEnvironment' | 'SuccessfulRemoval', ParentType, ContextType>
};

export type UserResultResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['UserResult'] = ResolversParentTypes['UserResult']> = {
  __resolveType: TypeResolveFn<'User' | 'UserNotFound' | 'InvalidDataFormat', ParentType, ContextType>
};

export type RequestPasswordResetEmailResultResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['RequestPasswordResetEmailResult'] = ResolversParentTypes['RequestPasswordResetEmailResult']> = {
  __resolveType: TypeResolveFn<'EmailMayHaveBeenSent' | 'InvalidDataFormat', ParentType, ContextType>
};

export type ResetPasswordResultResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['ResetPasswordResult'] = ResolversParentTypes['ResetPasswordResult']> = {
  __resolveType: TypeResolveFn<'User' | 'InvalidOrExpiredToken' | 'PasswordsDontMatch' | 'WantsSamePassword' | 'InvalidDataFormat', ParentType, ContextType>
};

export type LoginWithExternalProviderResultResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['LoginWithExternalProviderResult'] = ResolversParentTypes['LoginWithExternalProviderResult']> = {
  __resolveType: TypeResolveFn<'SuccessfulLogin' | 'InvalidOrMissingUserIdentifier' | 'SkippedOAuthFlow', ParentType, ContextType>
};

export type SignupResultResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['SignupResult'] = ResolversParentTypes['SignupResult']> = {
  __resolveType: TypeResolveFn<'SuccessfulSignup' | 'InvalidDataFormat' | 'TakenUsernameOrEmail', ParentType, ContextType>
};

export type SignupWithExternalProviderResultResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['SignupWithExternalProviderResult'] = ResolversParentTypes['SignupWithExternalProviderResult']> = {
  __resolveType: TypeResolveFn<'SuccessfulSignup' | 'InvalidDataFormat' | 'TakenUsernameOrEmail' | 'SkippedOAuthFlow' | 'InvalidOrExpiredToken', ParentType, ContextType>
};

export type LoginResultResolvers<ContextType = ApolloContext, ParentType extends ResolversParentTypes['LoginResult'] = ResolversParentTypes['LoginResult']> = {
